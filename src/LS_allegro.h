...
/***********************************************************************************************************************
 *
 * @Proposito: Modulo proporcionado por los becarios para arrancar las funciones elementales que nos permiten jugar con
 *             las ventanas graficas a lo largo del programa
 *
